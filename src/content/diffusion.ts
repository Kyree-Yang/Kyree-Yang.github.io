  ...
  sections: [
    {
      id: 'pipeline',
      heading: 'Pipeline',
      body: 'This is a class project from EECS 442 Computer Vision at UMich. With two teammates, we focused on improving the diversity and controllability of text-to-image diffusion models through advanced data augmentation techniques. The idea of implementing text augmentation was inspired by Professor Liyue Shen, whose insightful guidance and encouraging feedback were invaluable during the project.',
      viz: ['PipelineDiagram'],
    },
    {
      id: 'contributions',
